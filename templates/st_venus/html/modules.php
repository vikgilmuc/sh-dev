...
function modChrome_avatarmodule($module, &$params, &$attribs)
{
	if (!empty ($module->content)) : ?>
		<div id="<?php echo $module->id; ?>" class="avatar-module <?php echo htmlspecialchars($params->get('moduleclass_sfx')); ?>">
		<?php if ($module->showtitle != 0) : ?>
			<h3 class="st-module-heading"><span><span><?php echo $module->title; ?></span></span></h3>
		<?php endif; ?>
