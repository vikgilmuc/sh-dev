...
require_once 'templates/shtemplate2/includes/class.rwa_oauth.inc.php';
require_once 'templates/shtemplate2/includes/class.rwa_facebook.inc.php';
// Loads the $fb_config array

require_once 'templates/shtemplate2/includes/fb_config.inc.php';
...
<div id="show_loginlogout">
    ...
    border:1px solid blue;"> Show Login</a>
    ...
    id="login-form" >
        ...
        <fieldset class="userdata">
            ...
            <label for="modlgn-username" > 
                <?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?> </label>
