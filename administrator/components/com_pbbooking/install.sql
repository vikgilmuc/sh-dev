...
this is a test form the booking system<p>|*URL*|



<p>You\'re gender is |*gender*|</p>', '[{"status":"open","open_time":"1000","close_time":"2000"},{"status":"open","open_time":"1000","close_time":"2000"},{"status":"open","open_time":"1000","close_time":"2000"},{"status":"open","open_time":"1000","close_time":"2000"},{"status":"open","open_time":"1000","close_time":"2000"},{"status":"open","open_time":"0900","close_time":"1700"},{"status":"closed"}]', 'Your Treatment Verification', 'http://127.0.0.1/joomla', 'Australia/Brisbane', 0, '<b>change this <i>calendar message</i> to something more appropriate</b>', '<b>change this <i>create message</i> to something more appropriate</b>', 0, 1, '%A %e/%m', '%e/%m/%G', '%e/%m', 0, 'top secret', 'username', 'password', 0, 0, 0, '{"morning":{"display_label":"morning","shift_start":"1000","shift_end":"1200"},"afternoon":{"display_label":"afternoon","shift_start":"1330","shift_end":"1700"},"evening":{"display_label":"evening","shift_start":"1700","shift_end":"1930"}}', 30, 1, 1, 1, 'client', 1);
